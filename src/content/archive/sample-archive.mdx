---
title: "Sample Archive Post"
date: "2026-01-17"
description: "A sample post to demonstrate the Archive functionality"
tags: ["Archive", "sample", "draft"]
---

## Welcome to Archive

This is a sample Archive post. It demonstrates how the Archive section works:
...
- **Archive badge**: Notice the "Archive" badge indicating this is a draft

### Use Cases

The Archive section is perfect for:
...
When you're ready to publish a Archive post, simply move the `.mdx` file from `src/content/Archive/` to `src/content/blog/`.
