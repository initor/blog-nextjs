...
<FigCaption>Each session is ephemeral. The planning files are not. Work flows in, gets distilled, and the next session inherits a smaller, sharper context than the one before.</FigCaption>
