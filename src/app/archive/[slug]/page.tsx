...
export async function generateMetadata({
  ...
  const post = await getPostBySlug(resolvedParams.slug, 'archive');
  ...
  return {
    title: `${post.frontMatter.title} | Archive | ${blogConfig.title}`,
    ...
    openGraph: {
      ...
      url: `${blogConfig.siteUrl}/archive/${post.slug}`,
    ...
    <article className="max-w-4xl mx-auto px-4 py-8">
      <header className="mb-6">
        <div className="flex items-start gap-3 mb-1.5">
          ...
          <span className="archive-badge mt-2">Archive</span>
        </div>
